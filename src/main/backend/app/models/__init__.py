...
class AIToolCall(TimestampMixin, Base):
    ...
    output_bytes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    payload_tokens: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    output_tokens: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    cache_hit: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    drilldown: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
...
class AIQueryMetric(TimestampMixin, Base):
    ...
    context_calls_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    bytes_returned: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    approx_tokens_returned: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    bytes_sent: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    approx_tokens_sent: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    cache_hit_rate: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    drilldown_rate: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
